...
export function SectionHeading({ title, copy }: SectionHeadingProps) {
  return (
    <div className="space-y-3 text-center md:text-left">
      ...
      <p className="mx-auto max-w-3xl text-base leading-8 text-slate-600 sm:text-lg md:mx-0">{copy}</p>
    </div>
  );
}
...
export function DecorativeCard({
  ...
  return (
    <div className="relative overflow-hidden rounded-[2rem] bg-slate p-7 text-white sm:p-8">
